-- Correct sample data matching the actual database schema

-- Insert sample enterprises (without description column)
...
-- Insert sample departments (check actual schema first)
INSERT INTO departments (name, enterprise_id, created_at, updated_at) VALUES
-- TechCorp Solutions departments
('IT Support', 1, NOW() - INTERVAL '6 months', NOW()),
('Development', 1, NOW() - INTERVAL '5 months', NOW()),
('Operations', 1, NOW() - INTERVAL '4 months', NOW()),

-- HealthCare Plus departments
('Emergency', 2, NOW() - INTERVAL '4 months', NOW()),
('Nursing', 2, NOW() - INTERVAL '3 months', NOW()),
('Administration', 2, NOW() - INTERVAL '3 months', NOW()),

-- RetailMax Chain departments
('Sales Floor', 3, NOW() - INTERVAL '3 months', NOW()),
('Warehouse', 3, NOW() - INTERVAL '2 months', NOW()),
('Management', 3, NOW() - INTERVAL '2 months', NOW()),

-- Manufacturing Pro departments
('Production', 4, NOW() - INTERVAL '8 months', NOW()),
('Quality Control', 4, NOW() - INTERVAL '7 months', NOW());

-- Insert sample users (check actual schema)
...
SELECT 'Correct data insertion completed successfully!' as status;
SELECT 
