-- Basic sample data for testing the system admin dashboard
-- This creates minimal data to test the dashboard functionality
...
(5, 'Shift Assignment', 'You have been assigned to IT Support morning shift', 'shift_assigned', NOW() - INTERVAL '1 week', NOW() - INTERVAL '2 weeks', NOW()),
(6, 'Swap Request Approved', 'Your shift swap request has been approved', 'swap_request_approved', NULL, NOW() - INTERVAL '5 days', NOW()),
(11, 'New Roster Published', 'Emergency department roster has been published', 'roster_published', NULL, NOW() - INTERVAL '3 weeks', NOW()),
(17, 'Shift Reminder', 'You have an upcoming shift tomorrow', 'schedule_changed', NULL, NOW() - INTERVAL '1 day', NOW());

-- Verify the data was inserted
SELECT 'Basic data insertion completed successfully!' as status;
SELECT 
