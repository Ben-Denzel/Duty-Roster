-- Minimal sample data for testing the system admin dashboard
-- This creates just the essential data needed to test the dashboard
...
-- Insert a few basic rosters to have some data
...
SELECT 'Minimal data insertion completed successfully!' as status;
SELECT 
